...
while (p <= rep_count){
  ...
  random_genes <- sample(1:ncol(model_data %>% select(-one_of("days", "class"))), size = gene_len)
...
# write to file
destdir <- paste0(sourcedir, 'random/')
cox_random_file <- paste0(destdir,"cox_random_results_",gene_len,".txt")
